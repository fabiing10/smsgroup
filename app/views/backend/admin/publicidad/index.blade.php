                ...
                <div class="panel-body">
                    <table class="table table-hover demo-table-dynamic" id="tableWithDynamicRows">
                        ...
                        <tr>
                            ...
                            <th style="width: auto;">Publicidad</th>
                        ...
                        <tr>
                            ...
                            <td class="v-align-middle">{{ $publicidad->nombre }}</td>
                            <td class="v-align-middle">{{ $publicidad->titulo }}</td>
                            <td class="v-align-middle">{{ mb_substr($publicidad->descripcion, 0, 150) }} ...</td>
                            <td>
                                <div class="btn-group">
                                    <button type="button" class="btn btn-danger eliminar-publicidad"  data-value="{{Crypt::encrypt($publicidad->id)}}"><i class="fa fa-trash-o"></i>
                                    </button>
                                </div>
                            </td>
                        </tr>
...
@include('backend.admin.publicidad.nuevo')
