<!-- MODAL STICK UP  -->
<div class="modal fade stick-up" id="modal-actualizar-administrador" tabindex="-1" role="dialog" aria-labelledby="nuevoAdministrador" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header clearfix ">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="pg-close fs-14"></i>
                </button>
                <h4 class="p-b-5"><span class="semi-bold">Actualizar</span> Administrador</h4>
            </div>
            <div class="modal-body">
                <p class="small-text">Es facil! Solo debes completar el siguiente formulario</p>

                {{ Form::open(array('url' => 'admin/administradores/actualizar', 'class' => 'nuevo-administrador', 'role' => 'form')) }}
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-cons" onclick="clodeWindows('modal-actualizar-administrador')">Cerrar</button>
                </div>
